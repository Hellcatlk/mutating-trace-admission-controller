...
func InjectPatch(r *http.Request, ar *v1beta1.AdmissionReview) (response *v1beta1.AdmissionResponse) {
	...
	spanContext, _ := trace.SpanContextFromRequestHeader(r)
...
func buildPatchAnnotations(initTraceID string, spanContext octrace.SpanContext) (map[string]string, error) {
